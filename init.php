...
$c2 = $courseController->create('Norsk', '5', '2', new DateTime('2015-01-01'));
$c3 = $courseController->create('Mobile App Design', '5', '1', new DateTime('2014-10-01'));
$c4 = $courseController->create('Programming for the Web', '10', '2', new DateTime('2015-01-01'));
...
$c7 = $courseController->create('Programming for the Web II', '10', '1', new DateTime('2015-01-01'));
$c8 = $courseController->create('Programming for the Web II', '10', '2', new DateTime('2015-01-01'));
...
$g1 = $gradeController->create($s1->getId(),$c2->getId(),'A', new DateTime('2014-03-08'));
$g2 = $gradeController->create($s2->getId(),$c2->getId(),'E', new DateTime('2014-01-11'));
$g3 = $gradeController->create($s3->getId(),$c3->getId(),'C', new DateTime('2014-01-01'));
$g4 = $gradeController->create($s4->getId(),$c4->getId(),'B', new DateTime('2015-03-01'));
$g5 = $gradeController->create($s5->getId(),$c5->getId(),'D', new DateTime('2014-12-05'));
...
$g8 = $gradeController->create($s3->getId(),$c4->getId(),'B', new DateTime('2015-01-05'));
$g9 = $gradeController->create($s4->getId(),$c5->getId(),'A', new DateTime('2014-03-01'));
